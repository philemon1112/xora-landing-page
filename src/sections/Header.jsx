            ...
            <div className='container flex h-14 items-center max-lg:px-5'>
                ...
                <div className={clsx('w-full max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:w-full max-lg:bg-s2 max-lg:opacity-0', isOpen ? 'max-lg:opacity-100' : 'max-lg:pointer-events-none')}>
                    <div className=' max-lg:relative max-lg:flex max-lg:flex-col max-lg:min-h-screen max-lg:p-6 max-lg:overflow-hidden sidebar-before max-md:px-4'>
                        <nav className='mzx-lg:relative max-lg:z-2 max-lg:my-auto'>
                        ...
                        <div className="lg:hidden block absolute top-1/2 left-0 w-[960px] h-[380px] translate-x-[-290px] -translate-y-1/2 rotate-90">
                            ...
                            <img src="/images/bg-outlines-film.png" width={960} height={380} alt="outline" className='absolute insert-0 mix-blend-soft-light opacity-5' />
                        </div>
                    </div>
                </div>

                <button onClick={() => setIsOpen(!isOpen)} className='lg:hidden z-2 size-10 border-2 border-s4/25 rounded-full flex items-center justify-center'>
